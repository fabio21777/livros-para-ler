...
# 📚 Livros Essenciais de Engenharia de Software
 
Lista de leitura recomendada — cobre criação de sistemas, comunicação entre eles, gestão de complexidade e tomada de decisão sob incerteza.
 
> Curadoria retirada do artigo [Path to Vibe Engineering](https://leandronsp.com/articles/path-to-vibe-engineering) de Leandro Proença.
...
- [ ] **Fundamentos de Arquitetura de Software** — *Mark Richards & Neal Ford*
  Padrões de arquitetura, tradeoffs, modularidade, como decidir quando não existe resposta certa. O capítulo sobre análise de tradeoffs sozinho já vale o livro inteiro.
- [X] **Arquitetura de Software: As Partes Difíceis** — *Mark Richards, Neal Ford, Pramod Sadalage & Zhamak Dehghani*
